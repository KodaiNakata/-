...
public class Calculation {
	 ...
	 */
	public static <T>void exchangeArrayArrayList(ArrayList<ArrayList<T>>arrayArrayList,int beforeCol,int beforeRow,int afterCol,int afterRow){
...
//	}
	...
	/*
	 * 多次元の動的配列の追加
	 * arraysList:追加される2次元の動的配列
	 * arrayList:追加する1次元の動的配列
	 * col:何行目か
	 * number:何番目の要素を追加するか
	 */
	public static<T>void addArrayArrayList(ArrayList<ArrayList<T>> arraysList,
			ArrayList<T> arrayList, int col,int row,int number){
